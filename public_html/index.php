	...
	<div style="text-align: center;">
		...
		<div>
			<a class="github-button" href="https://github.com/tito10047/phptojs" data-icon="octicon-eye"
			   ...
			   data-count-api="/repos/tito10047/phptojs#subscribers_count" data-count-aria-label="# watchers on GitHub"
			   aria-label="Watch tito10047/phptojs on GitHub">Watch</a>
			<a class="github-button" href="https://github.com/tito10047/phptojs" data-icon="octicon-star"
			   data-style="mega" data-count-href="/tito10047/phptojs/stargazers"
			   data-count-api="/repos/tito10047/phptojs#stargazers_count" data-count-aria-label="# stargazers on GitHub"
			   aria-label="Star tito10047/phptojs on GitHub">Star</a>
			<a class="github-button" href="https://github.com/tito10047/phptojs/issues" data-icon="octicon-issue-opened"
			   data-style="mega" data-count-api="/repos/tito10047/phptojs#open_issues_count"
			   data-count-aria-label="# issues on GitHub" aria-label="Issue tito10047/phptojs on GitHub">Issue</a>
		</div>
	</div>
		...
		<tr>
			<td>
				...
				<div style="height: 600px;">
                        <pre style="height: 600px;width: 554px;border: 1px solid #a9a9a9;" id="phpCodeColoredPre"><code
								id="phpCodeColored"
								style="width: 100%;height: 100%;border: 1px solid #a9a9a9;display: block;">&lt;?php

</code></pre>
                        <textarea id="phpCode"
								  style="width: 554px;height: 600px;border: 1px solid #a9a9a9;white-space: pre;"
								  class="hidden">&lt;?php
			...
			<td>
				...
				<div style="height: 600px;">
                        <pre style="height: 600px;">
                            <code id="jsCode"
								  style="width: 554px;height: 600px;border: 1px solid #a9a9a9;display: block;"></code>
                        </pre>
				</div>
			</td>
		</tr>
